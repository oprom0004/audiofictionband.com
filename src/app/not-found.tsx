...
export default function NotFound() {
  useEffect(() => {
    document.title = `404 Page Not Found - ${COMMON_COPYWRITE.brandName} 800V DC Series`;
  }, []);
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20 text-center font-sans">
      ...
      {/* Helpful Inner Navigation Grid */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-lg mx-auto mb-10 text-left">
        <Link 
          href="/" 
          className="p-4 bg-[#121214] border border-gray-800 rounded-xl hover:border-cyan-500/30 transition group cursor-pointer"
        >
          <div className="flex items-center gap-3">
            <Home size={16} className="text-cyan-400 group-hover:scale-110 transition" />
            <div>
              <span className="block text-xs font-bold text-gray-200">Home</span>
        ...
        >
          <div className="flex items-center gap-3">
            <BookOpen size={16} className="text-cyan-400 group-hover:scale-110 transition" />
            <div>
              <span className="block text-xs font-bold text-gray-200">1A-6A Specs</span>
        ...
        <Link 
          href="/programmable-800v-dc-psu" 
          className="p-4 bg-[#121214] border border-gray-800 rounded-xl hover:border-cyan-500/30 transition group cursor-pointer"
        >
          <div className="flex items-center gap-3">
            <Settings size={16} className="text-cyan-400 group-hover:scale-110 transition" />
            <div>
        ...
        <Link 
          href="/afb-power-etm-series-faq" 
          className="p-4 bg-[#121214] border border-gray-800 rounded-xl hover:border-cyan-500/30 transition group cursor-pointer"
        >
          <div className="flex items-center gap-3">
            <HelpCircle size={16} className="text-cyan-400 group-hover:scale-110 transition" />
            <div>
      ...
      <div className="flex justify-center gap-4">
        <Link
          href="/"
          className="py-2.5 px-5 bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-400 hover:to-cyan-500 text-gray-950 font-extrabold text-xs uppercase rounded-lg transition-all duration-200 flex items-center gap-1.5 cursor-pointer"
        >
          <Home size={13} />
          Back to Directory
        </Link>
